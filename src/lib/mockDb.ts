...
const seedRestaurants: Restaurant[] = [
  ...
  },
  {
    ...
    address: 'QA Avenue',
    settings: { currency: 'INR', gst_percentage: 5, service_charge_percentage: 10 },
    subscription_plan: 'pro',
    subscription_status: 'active',
...
const seedProfiles: Profile[] = [
  ...
  { id: 'e2e-owner-1', restaurant_id: 'e2e-rest-1', email: 'owner@test.com', full_name: 'QA Owner', role: 'owner' },
  { id: 'e2e-manager-1', restaurant_id: 'e2e-rest-1', email: 'manager@test.com', full_name: 'QA Manager', role: 'staff' },
  { id: 'e2e-waiter-1', restaurant_id: 'e2e-rest-1', email: 'waiter@test.com', full_name: 'QA Waiter', role: 'staff' },
  { id: 'e2e-kitchen-1', restaurant_id: 'e2e-rest-1', email: 'kitchen@test.com', full_name: 'QA Kitchen', role: 'staff' },
  { id: 'e2e-cashier-1', restaurant_id: 'e2e-rest-1', email: 'cashier@test.com', full_name: 'QA Cashier', role: 'staff' },
  { id: 'e2e-superadmin-1', restaurant_id: null, email: 'superadmin@test.com', full_name: 'QA SuperAdmin', role: 'super_admin' }
];
...
const seedMenuItems: MenuItem[] = [
  ...
  },
  {
    ...
    category_id: 'e2e-cat-1',
    name: 'Chicken Tikka',
    description: 'Spiced chicken chunks',
    price: 250.00,
    is_available: true,
    is_veg: false
  }
