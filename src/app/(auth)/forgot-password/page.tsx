...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const siteOrigin = (process.env.NEXT_PUBLIC_SITE_URL || (typeof window !== 'undefined' ? window.location.origin : 'https://www.cleverops.in')).replace(/\/$/, '');
      ...
      if (resetErr) {
        setError(resetErr.message || 'Failed to send password reset email. Please try again.');
      } else {
        setSent(true);
      }
    } catch (err: any) {
