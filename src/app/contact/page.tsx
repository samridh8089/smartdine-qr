        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl space-y-4 shadow-sm">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Direct phone support for restaurant onboarding and onboarding assistance:
              </p>
              <a href="tel:+917742054535" className="text-slate-900 dark:text-white font-extrabold text-base hover:underline block">
                +91 77420 54535
              </a>
            </div>
