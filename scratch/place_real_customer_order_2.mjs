...
(async () => {
  console.log('[Puppeteer] Launching browser for 2nd order...');
  ...
  try {
    ...
    console.log('[Puppeteer] 2nd order placed successfully!');

  } catch (err) {
    console.error('[Puppeteer] Error placing 2nd order:', err.message);
  } finally {
    await browser.close();
  }
})();
